  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav nav-justified">
            <li class="box1">
				<a href="hr.php?action=dipendenti">
            ...
            <li class="box1">
                <a href="hr.php?action=cv-esterno">
                    <i class="fa fa-id-card-o fa-4x"></i>
                    <h5>Inserimento CV Esterno</h5>
                </a>
            </li>

            <li class="box1">
                <a href="hr.php?action=ricerca-cv-esterno">
                    <i class="fa fa-search fa-4x"></i>
                    <h5>Ricerca CV Esterno</h5>
                </a>
            </li>

            <li class="box1">
				<a href="hr.php?action=buste-paga">
...
-->
			...
			<li class="box1">
				<a href="hr.php?action=costi">
					<i class="fa fa-money fa-4x"></i>
					<h5>Costi Dipendenti</h5>
				</a>
            </li>

            <li class="box1">
      				<a href="hr.php?action=posizioni">
      					<i class="fa fa-briefcase fa-4x"></i>
      					<h5>Posizioni Aperte</h5>
      				</a>
                  </li>
...
<?php
    ...
    } else if($_GET['action'] == "presenze") {
        include('hr_presenze.php');
    } else if($_GET['action'] == "cv-esterno") {
        include('hr_cv.php');
    } else if($_GET['action'] == "ricerca-cv-esterno") {
        include('hr_ricerca_cv.php');
    } else if($_GET['action'] == "buste-paga") {
        include('hr-buste-paga.php');
    } else if($_GET['action'] == "lul") {
        include('hr_lul.php');
    } else if($_GET['action'] == "mail") {
        include('hr_mail.php');
    } else if($_GET['action'] == "costi") {
        include('hr_costi.php');
    } else if($_GET['action'] == "posizioni") {
        include('hr_posizioni_aperte.php');
    }
?>
