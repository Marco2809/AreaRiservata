...
require_once('class/richieste.class.php');
...
<html lang="en">
  <head>
    ...
    <title>AREA RISERVATA - HR - RECRUITMENT</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav nav-justified">
			<li class="box1">
				<a href="hr-recruitment.php?action=richieste">
					<i class="fa fa-arrow-down fa-4x"></i>
					<h5>Richieste</h5>
				</a>
            </li>
            <li class="box1">
                <a href="hr-recruitment.php?action=cv-esterno">
                    <i class="fa fa-id-card-o fa-4x"></i>
                    <h5>Inserimento CV Esterni</h5>
                </a>
            </li>
            <li class="box1">
                <a href="hr-recruitment.php?action=posizioni">
...
<!--FINE CASELLE MENU-->
<?php
    if ($_GET['action'] == "richieste") {
        include('hr_richieste.php');
