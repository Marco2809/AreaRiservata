...
<html lang="en">
  <head>
    ...
    <title>AREA RISERVATA - HR - GESTIONE DEL PERSONALE</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav nav-justified">
            <li class="box1">
      				<a href="hr-gestione-personale.php?action=dipendenti">
      					<i class="fa fa-list fa-4x"></i>
      					<h5>Lista Dipendenti</h5>
      				</a>
            </li>
            <li class="box1">
      				<a href="hr-gestione-personale.php?action=archivio">
      					<i class="fa fa-archive fa-4x"></i>
      					<h5>Archivio</h5>
      				</a>
            </li>
            <li class="box1">
              <a href="hr-gestione-personale.php?action=new">
                <i class="fa fa-list fa-4x"></i>
                <h5>Nuovo Dipendente</h5>
              </a>
            </li>
            <li class="box1">
                <a href="hr-gestione-personale.php?action=timesheet">
                    <i class="fa fa-calendar fa-4x"></i>
                    <h5>Timesheet</h5>
                </a>
            </li>
            <li class="box1">
                <a href="hr-gestione-personale.php?action=commesse">
                    <i class="fa fa-briefcase fa-4x"></i>
                    <h5>Commesse</h5>
                </a>
            </li>
            <li class="box1">
				<a href="hr-gestione-personale.php?action=buste-paga">
					<i class="fa fa-euro fa-4x"></i>
					<h5>Buste Paga</h5>
				</a>
            </li>
            <li class="box1">
				<a href="hr-gestione-personale.php?action=modulistica">
					<i class="fa fa-file fa-4x"></i>
					<h5>Modulistica</h5>
				</a>
            </li>
			<!--<li class="box1">
				<a href="hr-gestione-personale.php?action=categorie-protette">
					<i class="fa fa-handshake-o fa-4x"></i>
					<h5>Categorie Protette</h5>
				</a>
      </li>-->
        </ul>
...
<!--FINE CASELLE MENU-->
<?php
    if($_GET['action'] == "dipendenti") {
        include('hr_dipendenti.php');
    } else if($_GET['action'] == "archivio") {
        include('hr_archivio.php');
    } else if($_GET['action'] == "new") {
        include('nuovo_utente.php');
    } else if($_GET['action'] == "timesheet") {
        include('timesheet-admin.php');
    } else if($_GET['action'] == "commesse") {
        include('commesse.php');
    } else if($_GET['action'] == "buste-paga") {
        include('hr-buste-paga.php');
    } else if($_GET['action'] == "modulistica") {
        include('hr_modulistica.php');
    } else if($_GET['action'] == "categorie-protette") {
