...
<html lang="en">
  <head>
    ...
    <title>AREA RISERVATA - HR - RICERCA & STATISTICHE</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav nav-justified">
			<li class="box1">
				<a href="hr-ricerca-statistiche.php?action=ricerca-cv">
					<i class="fa fa-file-text-o fa-4x"></i>
					<h5>Ricerca CV Interni</h5>
				</a>
            </li>
            <li class="box1">
                <a href="hr-ricerca-statistiche.php?action=ricerca-cv-esterno">
                    <i class="fa fa-search fa-4x"></i>
                    <h5>Ricerca CV Esterni</h5>
                </a>
            </li>
            <li class="box1">
                <a href="hr-ricerca-statistiche.php?action=ricerca-anagrafica">
                    <i class="fa fa-user fa-4x"></i>
                    <h5>Ricerca Anagrafica</h5>
                </a>
            </li>
        </ul>
    </div>
...
<!--FINE CASELLE MENU-->
<?php
    if ($_GET['action'] == "ricerca-cv") {
        include('ricerca-cv.php');
    } else if ($_GET['action'] == "ricerca-cv-esterno") {
        include('hr_ricerca_cv.php');
    } else if($_GET['action'] == "ricerca-anagrafica") {
        include('hr_ricerca_anagrafica.php');
    }
?>
