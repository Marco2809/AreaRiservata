...
require_once('class/progetti.class.php');
...
<html lang="en">
  <head>
    ...
    <title>AREA RISERVATA - PROGETTI</title>
...
<!--FINE CASELLE MENU-->
<?php
    if($_GET['action'] == "progetti"||!isset($_GET['action'])) {
        include('progetti_info.php');
    } else if($_GET['action'] == "membri") {
        include('progetti_membri.php');
    }
?>
