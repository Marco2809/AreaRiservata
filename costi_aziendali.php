...
<html lang="en">
  <head>
    ...
    <title>AREA RISERVATA - Costi Aziendali</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <ul class="nav nav-justified">
        <li class="box1">
			<a href="costi_aziendali.php?action=costi_aziendali">
			<i class="fa fa-user fa-4x"></i>
			<h5>Costi Aziendali</h5>
			</a>
		</li>
    <li class="box1">
      <a href="costi_aziendali.php?action=costi">
        <i class="fa fa-money fa-4x"></i>
        <h5>Costi del Lavoro</h5>
      </a>
          </li>
		<li class="box1">
			<a href="costi_aziendali.php?action=costi_upload">
			<i class="fa fa-upload fa-4x"></i>
			<h5>Caricamento Massivo</h5>
			</a>
		</li>
      </ul>
    </div>
...
<?php
    if($_GET['action']=="costi_aziendali") {
        include('costi.php');
	} else if($_GET['action']=="dettaglio") {
        include('costi_dettaglio.php');
	} else if($_GET['action']=="costi_upload") {
        include('costi_upload.php');
