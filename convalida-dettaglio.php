    ...
    switch($_GET['type']) {
        ...
        case 'refuse':
            $resultValidation = array('refuse', 
                $attivita->refuseActivity($_GET['activity'], $_GET['cause']));
            if($resultValidation[1] == 1) {
                ...
                $bodyMail .= 'in data odierna &#232; stata rifiutata l\'attività del timesheet relativa '
    ...
    switch($resultValidation[0]) {
        case 'validate':
            if($resultValidation[1] == 1) {
                echo '<div class="alert alert-success alert-dismissable fade in">
                        ...
                        <strong>Validazione effettuata!</strong> Hai validato con successo l\'attività selezionata.
                      </div>';
        ...
        case 'refuse':
            if($resultValidation[1] == 1) {
                echo '<div class="alert alert-success alert-dismissable fade in">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Validazione effettuata!</strong> Hai rifiutato con successo l\'attività selezionata.
                      </div>';
            } else if($resultValidation[1] == -1) {
                echo '<div class="alert alert-danger alert-dismissable fade in">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<?php
                        ...
                        $attivita = new Attivita();
                        $listaAttivita = $attivita->getActivityToValidateByJobsAndByUser($listaCommesse, 
                            ...
                            echo '<tr>
                                ...
                                <td>
                                    <a class="btn btn-success button-clear" 
                                        href="responsabile.php?action=convalida-dettaglio&id=' . $_GET['id'] . 
                                            '&type=validate&activity=' . $attivita[0] . 
...
?>
        ...
        <div class="pull-right" style="margin-bottom: 40px;">
            <a href="<?php echo 'responsabile.php?action=convalida&id-month=' . $id_mese . 
        ...
        <div class="modal-content">
            ...
            <form method="GET">
                <div class="modal-body">
                    <input type="hidden" value="convalida-dettaglio" name="action" id="action">
