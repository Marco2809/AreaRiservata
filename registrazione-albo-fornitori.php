...
<html lang="en">
  ...
  <body>
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <div id="login-page">
        <div class="container">
            <div class="panel panel-primary filterable" style="margin-top:5%;">
                ...
                <div class="panel-body">
                    ...
                    <form action="login-albo-fornitori.php" method="POST" name="register_supplier">
                        ...
                        <div class="col-md-12">
                            <input type="button" class="btn btn-success" name="register-supplier" value="Registrati"
