    ...
    <center>
        <div class="panel panel-primary">
            <div class="calendar-heading">
                <form action="costi_aziendali.php?action=dettaglio&id=<?php echo $_GET['id']; ?>" method="POST">
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
						...
						<th><input type="text" class="form-control" placeholder="Cognome"></th>
...
<?php
                    ...
                    $infoList = $infoHRClass->getAllDettaglioCostiAziendaliByMonth($id_mese,$id_anno,$_GET['id']);
					//print_r($infoList);
                    for($i=0;$i<count($infoList);$i+=4){
                        ...
                        echo '<tr>
							...
							<td>'.$infoList[$i+1].'</td>
								...
								<td>' . number_format($infoList[$i+3],2,".",""). '€</td>
                            </tr>';
                    }
?>
		 ...
		 <div class="pull-right" style="margin-bottom: 40px;">
            <a href="<?php echo 'costi_aziendali.php?action=costi_aziendali&id_mese=' . $id_mese . 
                                '&id_anno=' . $id_anno . ''; ?>" class="btn btn-default">
